...
https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/install-post.sh

return value is 0

```
wget https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/install-post.sh -c -O install-post.sh && bash install-post.sh && rm install-post.sh
```
...
```
wget https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/xs-install-post.env.sample -c -O xs-install-post.env
wget https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/install-post.sh -c -O install-post.sh
...
```
curl -O https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/debian-2-proxmox/debian11-2-proxmox7.sh && chmod +x debian11-2-proxmox7.sh
./debian11-2-proxmox7.sh
```
## Convert from Debian 10 to Proxmox 6 (debian10-2-proxmox6.sh) *optional*
```
curl -O https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/debian-2-proxmox/debian10-2-proxmox6.sh && chmod +x debian10-2-proxmox6.sh
./debian10-2-proxmox6.sh
```
## Convert from Debian 9 to Proxmox 5 (debian9-2-proxmox5.sh) *optional*
```
curl -O https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/debian-2-proxmox/debian9-2-proxmox5.sh && chmod +x debian9-2-proxmox5.sh
...
```
curl https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/helpers/pve-enable-lxc-docker.sh --output /usr/sbin/pve-enable-lxc-docker && chmod +x /usr/sbin/pve-enable-lxc-docker
...
```
wget https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/zfs/lvm-2-zfs.sh -c -O lvm-2-zfs.sh && chmod +x lvm-2-zfs.sh
./lvm-2-zfs.sh
```
...
```
wget https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/zfs/createzfs.sh -c -O createzfs.sh && chmod +x createzfs.sh
...
```
wget https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/zfs/xshok_slog_cache-2-zfs.sh -c -O xshok_slog_cache-2-zfs.sh && chmod +x xshok_slog_cache-2-zfs.sh
...
```
wget https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/networking/network-configure.sh -c -O network-configure.sh && chmod +x network-configure.sh
...
```
wget https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/networking/network-addiprange.sh -c -O network-addiprange.sh && chmod +x network-addiprange.sh
...
```
wget https://raw.githubusercontent.com/jicedtea/xshok-proxmox/modified/networking/tincvpn.sh -c -O tincvpn.sh && chmod +x tincvpn.sh
./tincvpn.sh -h
```
